...
export default function TermsPage() {
  ...
  return (
    <main className="relative flex flex-col min-h-screen w-full bg-red-950 overflow-hidden">
      ...
      {/* Extra center glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] lg:w-[700px] lg:h-[700px] bg-red-500 rounded-full blur-[100px] lg:blur-[140px] opacity-40 z-0 pointer-events-none fixed"></div>
