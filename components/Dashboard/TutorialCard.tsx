...
export default function GettingStartedGuide() {
  return (
    <div className="bg-white border border-zinc-200 rounded-[2rem] p-2 shadow-sm flex flex-col md:flex-row gap-4 items-center overflow-hidden">
      ...
      <div className="relative w-full md:w-48 h-32 bg-zinc-100 rounded-3xl overflow-hidden shrink-0 group cursor-pointer border border-zinc-200/50">
      ...
      <div className="flex-1 p-4 md:p-2 md:pr-6 flex flex-col justify-center">
        ...
        <Link href="#" className="inline-flex items-center text-sm font-semibold text-red-950 hover:text-red-600 transition-colors group">
          Read the full guide 
