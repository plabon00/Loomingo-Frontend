...
export default function OtherPagesFooter() {
  const footerLinks = {
    Product: [
  ...
  return (
    <footer className="relative bg-white/10  pt-24 pb-8 overflow-hidden w-full border-t border-zinc-100 flex flex-col items-center">
            ...
            <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 relative z-10 flex flex-col items-center">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 border-b border-zinc-200 pb-12">
                    ...
                    <div className="md:col-span-4 flex flex-col items-start text-left">
                        ...
                        <p className="text-sm text-white leading-relaxed max-w-xs mb-8">
                                        ...
                                        <li key={index} className="flex items-center gap-2">
                                            <Link
                                                ...
                                                className={`text-sm font-medium transition-colors duration-200 
                                                    ${link.disabled 
                                                        ? "text-zinc-300 pointer-events-none cursor-not-allowed" 
                ...
                {/* Copyright */}
                <div className="text-white font-medium text-xs sm:text-sm mt-8 mb-4 sm:mb-12"> 
